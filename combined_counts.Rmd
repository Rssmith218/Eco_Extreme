...
###ggplot
time.plot<- ggplot(time.data, aes(x= Time.Scale, y =n , fill = Sample.Scale)) + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + geom_bar(stat = "identity", position = "dodge")
...
####ggplot
spatial.plot<- ggplot(spatial.data, aes(x= Spatial.Scale, y =n , fill = Sample.Scale)) + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + geom_bar(stat = "identity", position = "dodge")
